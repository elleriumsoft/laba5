...
public class CreatingXmlBean implements SessionBean
{
    ...
    {
        return transformerToString("xml\\" + xmlData + ".xml",  "xslt\\" + xmlData + ".xsl");
    }

    private String transformerToString(String incomingFilename, String xslFilename)
    {
        ...
        try
        {
            ...
            Source source = new StreamSource(new FileInputStream(incomingFilename));
