    ...
    public String run(Integer element)
    {
        try
        {
            ...
            return  "Вы уверены, что хотите удалить " + nameForAdd + "?<br><br><br>" +
                    "    <input type= \"submit\" id= \"Button1 \" onclick= \"window.location.href='" + PATH_APP + "Structure.jsp?newname=delete';return false; \" name= \" \" value= \"ДА\" style= \"position:absolute;left:9px;top:100px;width:104px;height:25px;color:#FF0000; \">\n" +
                    "    <input type= \"submit\" id= \"Button1 \" onclick= \"window.location.href='" + PATH_APP + "Structure.jsp';return false; \" name= \" \" value= \"НЕТ\" style= \"position:absolute;left:109px;top:100px;width:104px;height:25px;color:#FF0000; \">\n";
